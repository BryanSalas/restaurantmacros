...
$.fn.fixedHeader = function (options) {
 ...
 return this.each( function() {
  ...
  $head.clone(true).removeClass('header').addClass('header-copy header-fixed').css({'position': 'fixed', 'top': config['topOffset'], 'background-color': config['bgColor']}).appendTo(o);
